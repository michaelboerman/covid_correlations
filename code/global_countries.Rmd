...
plot_one_date(
  ...
  subtitle = paste0("Using global-level data on ", 
...
# 
# Cases:
plot_correlations(df = cors_over_time,
                  x_series = "date",
                  y_series = "case_cor",
                  ylim <- 0.25,
                  ...
                  caption = "Data: UN Population Dynamics; Oxford COVID-19 Government Response Tracker. \n Calculations; Chart: Michael Boerman, https://github.com/michaelboerman",
...
plot_obs_used(
  data = cors_over_time,
  x_series = "date",
  y_series = "n_countries_deaths",
  title    = "Number of Counties or Regions used for Each Correlation",
